...
const createOrSkip = async (Model, data, identifier = 'email') => {
  try {
    ...
    console.log(`✅ Created ${Model.modelName}: ${data[identifier] || data.firstName || data.name}`);
    return created;
  } catch (error) {
    if (error.code === 11000) {
...
const seedPatientData = async () => {
  try {
    console.log('🚀 Starting Patient Seed Data...\n');
    ...
    console.log(`✅ Set favorites for ${createdPatients.length} patients`);
    ...
    console.log('\n📝 Creating Medicines (if not exist)...\n');
    const medicines = [];
    ...
    console.log(`✅ Created/Found ${medicines.length} Medicines`);
    
    console.log('\n📝 Creating Tests (if not exist)...\n');
    const tests = [];
    ...
    console.log(`✅ Created/Found ${tests.length} Tests`);
    ...
    console.log(`✅ Created ${notifications.length} Patient Notifications`);
    ...
    console.log('\n✅ Patient Seed Data Completed Successfully!\n');
    console.log('📊 Summary:');
