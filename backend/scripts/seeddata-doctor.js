...
const seedDoctorData = async () => {
  try {
    console.log('🚀 Starting Doctor Seed Data...\n');
    ...
    for (let i = 0; i < approvedDoctors.length && i < 3; i++) {
      ...
      for (const sessionDate of sessionDates) {
        ...
        console.log(`✅ Created Session for Dr. ${doctor.firstName} on ${sessionDate.toDateString()}`);
      }
    }
    ...
    console.log(`✅ Created ${notifications.length} Doctor Notifications`);
    
    console.log('\n✅ Doctor Seed Data Completed Successfully!\n');
    console.log('📊 Summary:');
