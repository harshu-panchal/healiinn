...
const addTestsToSpecificLab = async () => {
  try {
    console.log('🚀 Starting to Add 70 Tests to Specific Laboratory...\n');
    ...
    console.log(`🔍 Searching for laboratory with phone: ${phoneNumber}...\n`);
    ...
    if (!laboratory) {
      console.log(`❌ No laboratory found with phone number: ${phoneNumber}`);
      console.log('💡 Please make sure the laboratory is registered with this phone number.\n');
      process.exit(1);
    }
    
    console.log(`✅ Found Laboratory: ${laboratory.labName}`);
    ...
    console.log(`📝 Adding ${testData.length} tests to ${laboratory.labName}...\n`);
    ...
    console.log(`\n📊 Summary for ${laboratory.labName}:`);
    ...
    console.log(`✅ Total active tests for ${laboratory.labName}: ${finalTestCount}\n`);
