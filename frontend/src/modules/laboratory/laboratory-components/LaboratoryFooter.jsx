...
const footerLinks = {
  quickLinks: [
    ...
    { label: 'Profile', to: '/laboratory/profile' },
  ],
  resources: [
  ...
  legal: [
    ...
    { label: 'Lab Accreditation', to: '/laboratory/lab-accreditation' },
  ],
}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-sm text-slate-200 leading-relaxed mb-6 max-w-md">
              Your trusted diagnostic laboratory platform connecting laboratories and patients for accurate test results. 
              Empowering diagnostic professionals with advanced tools and seamless test management.
            </p>
        ...
        <div className="max-w-7xl mx-auto px-8 py-6">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-6 text-sm">
              ...
              <span className="text-slate-500">|</span>
              <NavLink
                to="/laboratory/terms-of-service"
                onClick={handleLinkClick}
                className="text-slate-300 hover:text-white transition-colors cursor-pointer"
              >
                Terms
