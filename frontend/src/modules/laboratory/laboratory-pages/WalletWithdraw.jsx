...
const WalletWithdraw = () => {
  ...
  const handleWithdraw = async () => {
    ...
    try {
      ...
      await requestLaboratoryWithdrawal(withdrawalData)
    ...
    <section className="flex flex-col gap-6 pb-4">
      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
        <div className="rounded-2xl border border-blue-100 bg-white p-5 shadow-sm">
          ...
          <p className="mt-2 text-2xl font-bold text-slate-900">{formatCurrency(withdrawData.availableBalance)}</p>
        ...
        <div className="rounded-2xl border border-emerald-100 bg-white p-5 shadow-sm">
          ...
          <p className="mt-2 text-2xl font-bold text-slate-900">{formatCurrency(withdrawData.thisMonthWithdrawals)}</p>
