...
const footerLinks = {
  quickLinks: [
    ...
    { label: 'Booking', to: '/nurse/booking' },
    { label: 'Transactions', to: '/nurse/transactions' },
    { label: 'Wallet', to: '/nurse/wallet' },
    { label: 'Profile', to: '/nurse/profile' },
  ],
  resources: [
    { label: 'Support', to: '/nurse/support' },
    { label: 'Privacy Policy', to: '/nurse/privacy-policy' },
    { label: 'Terms of Service', to: '/nurse/terms-of-service' },
    { label: 'FAQs', to: '/nurse/faq' },
  ],
  legal: [
    { label: 'Privacy Policy', to: '/nurse/privacy-policy' },
    { label: 'Terms & Conditions', to: '/nurse/terms-of-service' },
    { label: 'HIPAA Compliance', to: '/nurse/hipaa-compliance' },
    { label: 'Data Protection', to: '/nurse/data-protection' },
  ],
}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-sm text-slate-200 leading-relaxed mb-6 max-w-md">
              Your trusted healthcare platform connecting nurses and patients for better healthcare services. 
              Empowering nursing professionals with advanced tools and seamless patient management.
            </p>
