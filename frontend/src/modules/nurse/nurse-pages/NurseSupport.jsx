...
const NurseSupport = () => {
  ...
  return (
    <div className="mx-auto max-w-2xl lg:max-w-md py-4 lg:py-1">
      {/* Tabs */}
      ...
      {activeTab === 'new' && (
        <div className="rounded-xl border border-slate-200 bg-white p-4 shadow-sm">
          <div className="mb-2">
            <h1 className="text-lg font-bold text-slate-900">Support Request</h1>
            <p className="mt-0.5 text-xs text-slate-600">Fill out the form below and we'll get back to you soon.</p>
          </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-3">
          <div>
            ...
            <input
              ...
              required
              className="w-full rounded-lg border border-slate-200 bg-white px-3 py-2 text-xs font-medium text-slate-900 transition hover:border-slate-300 focus:border-[#11496c] focus:outline-none focus:ring-2 focus:ring-[#11496c]/20"
          ...
          <div>
            <label htmlFor="contactNumber" className="mb-1 block text-xs font-semibold text-slate-700">
          ...
          <div>
            <label htmlFor="note" className="mb-1 block text-xs font-semibold text-slate-700">
          ...
          <button
            ...
            className="w-full rounded-lg bg-[#11496c] px-4 py-2 text-xs font-semibold text-white shadow-sm shadow-[rgba(17,73,108,0.2)] transition hover:bg-[#0d3a52] disabled:cursor-not-allowed disabled:opacity-50"
          >
            {isSubmitting ? (
      ...
      {activeTab === 'tickets' && (
        <div className="rounded-xl border border-slate-200 bg-white p-4 shadow-sm">
          <div className="mb-2">
            <h1 className="text-lg font-bold text-slate-900">My Support Tickets</h1>
            <p className="mt-0.5 text-xs text-slate-600">View and track your support requests</p>
          </div>
      ...
      {activeTab === 'history' && (
        <div className="rounded-xl border border-slate-200 bg-white p-4 shadow-sm">
          <div className="mb-2">
            <h1 className="text-lg font-bold text-slate-900">Support History</h1>
            <p className="mt-0.5 text-xs text-slate-600">View your past support requests</p>
          </div>
